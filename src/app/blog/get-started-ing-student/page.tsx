...
const FAQS = [
  {
    question: "Do students in Enschede need a Dutch bank account?",
    answer:
  ...
  {
    question: "Why do students in Enschede care about iDEAL?",
    answer:
...
export const metadata: Metadata = {
  ...
  title: "Student Guide to Opening a Bank Account in Enschede (2026) | Student Jobs Enschede",
  description:
    "A practical guide for students moving to Enschede. Learn why a Dutch bank account helps with rent, salary payments, iDEAL, and everyday life in the Netherlands.",
  alternates: { canonical: CANONICAL },
  openGraph: {
    title: "Student Banking in Enschede: What You Need to Know",
    description:
      "Understand how Dutch banking works, what documents students usually need, and how to prepare for daily life in Enschede.",
    url: CANONICAL,
    type: "article",
    images: [{ url: `${BASE_URL}/blog/enschede-bridge.jpg` }],
  },
};

export default function IngPageEnschede() {
  const faqJsonLd = {
  ...
  const articleJsonLd = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "Opening a Dutch Bank Account in Enschede: A Practical Student Guide",
    description:
      "A practical guide for students moving to Enschede. Learn why a Dutch bank account helps with rent, salary payments, iDEAL, and everyday life in the Netherlands.",
    datePublished: PUBLISH_DATE,
    dateModified: MODIFIED_DATE,
    mainEntityOfPage: CANONICAL,
    image: [`${BASE_URL}/blog/enschede-bridge.jpg`],
    author: {
      "@type": "Organization",
      name: "Student Jobs Enschede Editorial",
    },
    publisher: {
      "@type": "Organization",
  ...
  const navItems = [
    ...
    { id: "city", label: "Banking in Enschede" },
    ...
    <article className="mx-auto max-w-7xl px-4 py-8 text-slate-800 sm:px-6 lg:px-8 lg:py-12">
      ...
      <header className="mb-10 border-b border-slate-200 pb-8">
        ...
        <h1 className="mb-6 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl lg:text-5xl">
          Opening a Dutch Bank Account in Enschede: A Practical Student Guide
        </h1>

        <p className="max-w-3xl text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">
          If you are moving to <strong>Enschede</strong> for your studies, setting
        ...
        <div className="mt-6 flex flex-wrap gap-x-3 gap-y-2 text-sm text-slate-500">
          ...
          <span className="hidden sm:inline">|</span>
          <span>By Student Jobs Enschede Editorial</span>
        </div>
      </header>
        ...
        <div className="space-y-12 text-base leading-7 sm:text-lg sm:leading-8">
          <section id="why" className="scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-slate-900">
              Why students in Enschede often open a Dutch bank account
            </h2>
            ...
            <p>
              ...
              account. However, for many students in <strong>Enschede</strong>,
          ...
          <Image
            src="/blog/enschede-bridge.jpg"
            alt="Student life in Enschede"
            width={1200}
            height={630}
          ...
          >
            <h2 className="mb-4 text-2xl font-bold text-slate-900">
              Banking as a student in Enschede
            </h2>

            <p className="mb-6 text-slate-700">
              Join the vibrant Twente student community properly—starting with a bank account that actually works at the local Albert Heijn on campus.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                ...
                <p className="text-sm leading-6 text-slate-700 sm:text-base">
                  A hidden gem in the east with a true, American-style campus at the University of Twente. It's green, highly active, and incredibly 'gezellig'.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm leading-6 text-slate-700 sm:text-base">
                  Hospitality in the Oude Markt is booming, and the university frequently hires students for events, IT support, and campus bar shifts.
                </p>
              </div>
            </div>

            <div className="mt-6 border-t border-slate-200 pt-6 text-sm italic text-slate-700 sm:text-base">
              <strong>Local note for Enschede:</strong> Because Enschede is right on the border, you might be tempted to survive on a German bank account. Don't. Dutch employers and DUO highly prefer a Dutch IBAN for fast, fee-free salary and grant processing.
            </div>
          </section>
